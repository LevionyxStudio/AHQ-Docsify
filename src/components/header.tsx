...
export function Header() {
  return (
    <header className="sticky top-4 inset-x-0 z-50 w-full">
      <div className="container mx-auto flex h-16 items-center rounded-full border border-border/40 bg-background/80 px-6 shadow-lg backdrop-blur-sm supports-[backdrop-filter]:bg-background/60">
